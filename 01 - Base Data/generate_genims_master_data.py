...
class DataGenerator:
    ...
    def generate_factories(self):
        ...
        for i in range(NUM_FACTORIES):
            ...
            factory = {
                "factory_id": self.generate_id("FAC", i + 1),
    ...
    def generate_machines(self):
        ...
        for line in self.production_lines:
            ...
            for k in range(num_machines):
                ...
                machine = {
                    "machine_id": self.generate_id("MCH", machine_counter),
                    ...
                    "last_major_overhaul": self.random_date(max(install_year + 5, 2020), 2024) if age > 5 else None,
    ...
    def generate_sensors(self):
        ...
        for machine in self.machines:
            ...
            for idx, sensor_type in enumerate(selected_sensors):
                ...
                sensor = {
                    "sensor_id": self.generate_id("SNS", sensor_counter),
    ...
    def generate_employees(self):
        ...
        for factory in self.factories:
            ...
            for _ in range(num_employees):
                ...
                # Assign line (only for production roles)
                line_id = None
                if role in ["operator", "supervisor", "quality_inspector"]:
                    line_id = random.choice(factory_lines)["line_id"] if factory_lines else None
                ...
                employee = {
                    "employee_id": self.generate_id("EMP", employee_counter),
                    "factory_id": factory["factory_id"],
                    "line_id": line_id,
    ...
    def generate_shifts(self):
        ...
        for factory in self.factories:
            for shift_template in SHIFTS:
                shift = {
                    "shift_id": self.generate_id("SHF", shift_counter),
                    "factory_id": factory["factory_id"],
    ...
    def generate_products(self):
        ...
        for idx, product in enumerate(PRODUCTS):
            prod = {
                "product_id": self.generate_id("PRD", idx + 1),
    ...
    def generate_customers(self):
        ...
        for idx, customer in enumerate(CUSTOMERS):
            cust = {
                "customer_id": self.generate_id("CUST", idx + 1),
        ...
        for line in self.production_lines:
            ...
            if line_products:
                ...
                for idx, product in enumerate(selected_products):
                    mapping = {
                        "mapping_id": self.generate_id("LPM", mapping_counter),
                        "line_id": line["line_id"],
    ...
    def generate_customer_product_mapping(self):
        ...
        for customer in self.customers:
            ...
            for product in selected_products:
                mapping = {
                    "mapping_id": self.generate_id("CPM", mapping_counter),
