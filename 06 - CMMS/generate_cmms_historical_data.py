        ...
        for factory in self.factories:
            for team_name in team_names:
                team = {
                    ...
                    'team_name': team_name,
                    'team_lead_id': random.choice(self.technicians)['technician_id'] if self.technicians else None,
        ...
        for asset in self.assets[:30]:
            ...
            for day in range(0, 90, 7):  # Weekly readings
                reading = {
                    ...
                    'recorded_by': random.choice(self.technicians)['technician_id'] if self.technicians else None,
